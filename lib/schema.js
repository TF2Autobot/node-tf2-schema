...
class Schema {
    ...
    _extractItemsGameLookups() {
        ...
        this.festivizableDefindexes = festivizableDefindexes;
        this.strangifierTargets = strangifierTargets;
    }
    ...
    isFestivizable(defindex) {
        return this.festivizableDefindexes ? this.festivizableDefindexes.has(Number(defindex)) : false;
    }

    getStrangifierTarget(defindex) {
        return this.strangifierTargets ? (this.strangifierTargets.get(Number(defindex)) ?? null) : null;
    }
